...
# Create a variable for the largest gender imbalance & gender imbalance for seminar 
largest_gender_imbalance = model.addVar(name="largest_gender_imbalance")
imbalance_vars = {}
for k in MSEM:
    imbalance_vars[k] = model.addVar(name=f"imbalance_{k}")
...
model.addConstr(largest_gender_imbalance <= 1.01 * zU_Gender, "Gender Priority")
