...
for i in range(len(STUDENTS)):
    ...
    # Create binary variables in x dictionary & Student choices dictionary
...
for k in SEMINARS:
	W_R_Star[k] = [(MSEM[k].X - FSEM[k].X)*(MSEM[k].X - FSEM[k].X), (US_SEM[k].X - NonUS_SEM[k].X)*(US_SEM[k].X - NonUS_SEM[k].X)]
...
for k in SEMINARS:
	W_G_Star[k] = [(MSEM[k].X - FSEM[k].X)*(MSEM[k].X - FSEM[k].X), ((US_SEM[k].X - NonUS_SEM[k].X) * (US_SEM[k].X - NonUS_SEM[k].X))]
...
for k in SEMINARS:
	W_C_Star[k] = [round((MSEM[k].X - FSEM[k].X)*(MSEM[k].X - FSEM[k].X)), round(((US_SEM[k].X - NonUS_SEM[k].X) * (US_SEM[k].X - NonUS_SEM[k].X)))]
