...
obj_functions= [gender_objective, rank_objective, citizenship_objective]
...
for i in range(3):
    ...
    # setObjectiveN ( expr, index, priority=0, 
    #               weight=1, abstol=1e-6, reltol=0, name="" )
     
    #model.setObjectiveN(objn, i, SetObjPriority[i], 
    #                   SetObjWeight[i],1.0 + i, 0.01, 'Set' + str(i))
    model.setObjectiveN(objn, i, SetObjPriority[i], obj_coef[i+1], 
                        abstol=0.05, reltol = 0.0, name = obj_names[i])
