...
model.setObjectiveN(rank_objective, index = 0, weight = obj_coef[1])
model.setObjectiveN(gender_objective, index = 1, weight = obj_coef[2])
model.setObjectiveN(citizenship_objective, index = 2, weight = obj_coef[2])
